...
public class ITimeJobFactory {
    ...
    static {
        ...
        map.put(TIMEJOB.CLEAR,new ClearTimerJobImpl());//的清理工作---                           【凌晨0时01分执行，周期每天】
        ...
        map.put(TIMEJOB.DAILY_BASIC,new DailyBasicTimerJobImpl());//每日股票指标抓取任务---                 【凌晨1时0分，周期每天】【多线程4，每3秒执行一次】【TuShare】【需要600积分】
        map.put(TIMEJOB.DIVIDEND,new DividendTimerJobImpl());//历史分红抓取任务                             【凌晨1时0分，周期每天】【多线程4，每6秒执行一次】【同花顺和东方财富并集】
        map.put(TIMEJOB.DYROE,new DyRoeAnalysisJobImpl());//ROE（净资产收益率）,DY（股息收益率）计算任务-                   【？？？没有找到调用代码】
